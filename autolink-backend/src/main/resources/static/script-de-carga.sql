...
(28500, 5, 150, 5, 0, 'Blanco', 'DIESEL', 'SUV', 1, 2, 'RAV4', true, true, 2023, '2026-02-21', '1234BBB', '2023-01-15', '2027-01-15', 'ECO', 'Híbrido autorrecargable en excelente estado, etiqueta ECO.', 'Madrid'),
(42000, 4, 250, 3, 15000, 'Negro', 'G98_SP', 'COUPE', 13, 2, 'M2', true, true, 2021, '2026-02-21', '5678CCC', '2021-06-10', '2025-06-10', 'C', 'Pura potencia alemana, muy cuidado, siempre en garaje.', 'Málaga'),
(15000, 5, 95, 5, 60000, 'Gris', 'G95_SP', 'HATCHBACK', 8, 2, 'Polo', true, false, 2019, NULL, '9012DDD', '2019-03-20', '2025-03-20', 'C', 'Compacto fiable y de bajo consumo, ideal para el día a día.', 'Sevilla'),
(210000, 2, 720, 2, 10, 'Rojo', 'G98_SP', 'SUPERCAR', 23, 2, 'F8 Tributo', true, false, 2024, NULL, '3456FFF', '2024-02-01', '2028-02-01', 'C', 'Vehículo de colección, prácticamente a estrenar.', 'Barcelona'),
(11500, 2, 119, 0, 0, 'Azul', 'G95_SP', 'MOTOCICLETA', 37, 2, 'MT-09', true, false, 2023, NULL, '7890GGG', '2023-05-12', '2027-05-12', 'C', 'Moto naked agresiva con tecnología de última generación.', 'Valencia'),
(24000, 5, 140, 5, 12000, 'Gris', 'DIESEL', 'SUV', 1, 2, 'Corolla Cross', true, true, 2022, '2026-02-20', '1122HHH', '2022-09-10', '2026-09-10', 'ECO', 'Familiar y eficiente, perfecto para viajes largos.', 'Zaragoza'),
(18000, 5, 122, 5, 30000, 'Blanco', 'G95_SP', 'SEDAN', 1, 2, 'Corolla', true, false, 2021, NULL, '3344JJJ', '2021-04-15', '2025-04-15', 'ECO', 'Berlina clásica con motorización híbrida de bajo mantenimiento.', 'Bilbao'),
...
(27000, 5, 155, 5, 22000, 'Rojo', 'G95_SP', 'SUV', 2, 2, 'Puma', true, false, 2022, NULL, '7788LLL', '2022-11-05', '2026-11-05', 'ECO', 'Diseño deportivo y maletero Megabox muy versátil.', 'Alicante'),
...
(19500, 5, 129, 5, 28000, 'Gris', 'G95_SP', 'SEDAN', 4, 2, 'Civic', true, true, 2021, '2026-02-20', '1212NNN', '2021-01-30', '2025-01-30', 'C', 'Dinámica de conducción excepcional y diseño futurista.', 'Valladolid'),
...
(17000, 5, 100, 5, 35000, 'Azul', 'G95_SP', 'HATCHBACK', 5, 2, 'i30', true, false, 2021, NULL, '5656QQQ', '2021-08-10', '2025-08-10', 'C', 'Equilibrio perfecto entre precio y equipamiento.', 'Gijón'),
...
(20000, 5, 140, 5, 26000, 'Gris', 'G95_SP', 'SUV', 7, 2, 'Qashqai', true, false, 2021, NULL, '9090SSS', '2021-12-05', '2025-12-05', 'ECO', 'El pionero de los SUV, muy fiable.', 'Elche'),
(22000, 5, 150, 5, 24000, 'Blanco', 'G95_SP', 'SUV', 8, 2, 'T-Roc', true, true, 2022, '2026-02-21', '1313TTT', '2022-05-18', '2026-05-18', 'C', 'Calidad Volkswagen en formato compacto.', 'Oviedo'),
...
(25000, 5, 165, 5, 15000, 'Gris', 'G95_SP', 'SUV', 9, 2, 'CX-5', true, true, 2022, '2026-02-20', '3535WWW', '2022-02-28', '2026-02-28', 'C', 'Diseño Kodo y acabados interiores de lujo.', 'Salamanca'),
(17500, 5, 115, 5, 34000, 'Azul', 'G95_SP', 'SUV', 10, 2, 'Captur', true, false, 2020, NULL, '4646XXX', '2020-11-15', '2024-11-15', 'C', 'Ágil y versátil para el entorno urbano.', 'Huelva'),
(14000, 5, 95, 5, 45000, 'Blanco', 'G95_SP', 'HATCHBACK', 10, 2, 'Clio', true, false, 2019, NULL, '5757YYY', '2019-06-30', '2025-06-30', 'C', 'Bajo consumo y fácil de aparcar.', 'Lérida'),
...
(13000, 4, 85, 3, 42000, 'Rojo', 'G95_SP', 'HATCHBACK', 12, 2, '500', true, false, 2018, NULL, '7979ABB', '2018-05-12', '2024-05-12', 'C', 'Estilo italiano inconfundible.', 'Burgos'),
(48000, 5, 258, 5, 12000, 'Negro', 'G98_SP', 'SEDAN', 13, 2, '330i', true, true, 2023, '2026-02-22', '8080ACC', '2023-07-18', '2027-07-18', 'C', 'Elegancia y deportividad en una sola pieza.', 'Albacete'),
(52000, 5, 265, 5, 10000, 'Gris', 'G98_SP', 'SEDAN', 14, 2, 'C300', true, true, 2023, '2026-02-22', '9191ADD', '2023-01-10', '2027-01-10', 'C', 'El referente en confort y lujo tecnológico.', 'Castellón'),
...
(98000, 4, 350, 5, 8000, 'Gris', 'G98_SP', 'SUV', 18, 2, 'Cayenne', true, true, 2023, '2026-02-23', '2424AGG', '2023-03-15', '2027-03-15', 'C', 'Prestaciones de deportivo en un cuerpo de SUV.', 'Madrid'),
...
(9800, 2, 110, 0, 2000, 'Negro', 'G95_SP', 'MOTOCICLETA', 36, 2, 'Ninja 650', true, false, 2023, NULL, '5757AKK', '2023-04-10', '2027-04-10', 'C', 'Moto sport-turismo ideal para iniciarse con el A2.', 'Valencia'),
(7200, 2, 75, 0, 5000, 'Azul', 'G95_SP', 'MOTOCICLETA', 37, 2, 'YZF-R7', true, false, 2022, NULL, '6868ALL', '2022-02-14', '2026-02-14', 'C', 'ADN de competición para disfrutar en curvas.', 'Málaga'),
(6800, 2, 70, 0, 8000, 'Rojo', 'G95_SP', 'MOTOCICLETA', 38, 2, 'GSX-8S', true, false, 2022, NULL, '7979AMM', '2022-10-01', '2026-10-01', 'C', 'Equilibrio y agilidad urbana.', 'Málaga'),
(15500, 2, 150, 0, 3000, 'Naranja', 'G98_SP', 'MOTOCICLETA', 40, 2, '1290 Super Duke', true, false, 2023, NULL, '8080ANN', '2023-06-25', '2027-06-25', 'C', 'La "Bestia" con toda la potencia de KTM.', 'Granada'),
(13500, 2, 120, 0, 4000, 'Negro', 'G98_SP', 'MOTOCICLETA', 41, 2, 'Street Triple', true, false, 2023, NULL, '9191APP', '2023-09-12', '2027-09-12', 'C', 'Agilidad legendaria y motor tricilíndrico.', 'Madrid'),
(17000, 2, 136, 0, 3500, 'Gris', 'G98_SP', 'MOTOCICLETA', 42, 2, 'S1000R', true, false, 2023, NULL, '0202AQQ', '2023-05-20', '2027-05-20', 'C', 'Referente en el segmento Maxinaked.', 'Madrid');
