...
@Component({
    ...
    <div class="grid grid-cols-1 lg:grid-cols-[250px_1fr] gap-8">
      ...
      <aside class="space-y-2">
        <a routerLink="/cliente" [routerLinkActiveOptions]="{exact: true}" routerLinkActive="bg-action-primary !text-surface-base shadow-lg shadow-action-primary/20"
        ...
        <a routerLink="/cliente/compras" routerLinkActive="bg-action-primary !text-surface-base shadow-lg shadow-action-primary/20"
           class="flex items-center gap-3 px-4 py-3 rounded-xl font-bold text-content-secondary hover:text-action-primary hover:bg-surface-card transition-all">
