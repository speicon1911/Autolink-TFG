...
@Component({
    ...
    <div class="space-y-6 animate-fade-in">
      ...
      <div *ngIf="!loading() && purchases().length === 0" class="text-center py-20 bg-slate-900/30 rounded-3xl border border-dashed border-slate-800">
      ...
      <div *ngIf="!loading() && purchases().length > 0" class="grid gap-4">
