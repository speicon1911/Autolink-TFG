    ...
    <div class="min-h-screen bg-surface-base text-content-primary py-20 px-4">
      <div class="max-w-3xl mx-auto space-y-8">
        <header class="space-y-4">
          <h1 class="text-4xl font-black tracking-tight text-content-primary italic">Términos de Servicio</h1>
        ...
        <section class="space-y-4 bg-surface-card p-8 rounded-2xl border border-white/5 backdrop-blur-sm">
          <h2 class="text-2xl font-bold text-action-primary">1. Aceptación de términos</h2>
        ...
        <section class="space-y-4 bg-surface-card p-8 rounded-2xl border border-white/5 backdrop-blur-sm">
          <h2 class="text-2xl font-bold text-action-primary">2. Responsabilidades del usuario</h2>
          <p class="leading-relaxed text-content-secondary">
        ...
        <section class="space-y-4 bg-surface-card p-8 rounded-2xl border border-white/5 backdrop-blur-sm">
          <h2 class="text-2xl font-bold text-action-primary">3. Propiedad intelectual</h2>
          <p class="leading-relaxed text-content-secondary">
