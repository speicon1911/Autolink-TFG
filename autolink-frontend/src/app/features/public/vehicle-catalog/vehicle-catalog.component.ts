...
@Component({
  ...
  template: `
    <div class="space-y-8 animate-fade-in px-4 sm:px-0">
      ...
      <div *ngIf="!loading() && vehiculos().length === 0" class="text-center py-20 space-y-4 bg-slate-900/20 rounded-3xl border border-dashed border-slate-800">
      ...
      <div *ngIf="!loading() && vehiculos().length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div *ngFor="let v of vehiculos()" 
          ...
          <div class="aspect-[16/10] bg-slate-800 relative group-hover:scale-105 transition-transform duration-700">
             ...
             <div *ngIf="v.verificado" class="absolute top-5 right-5 bg-white text-blue-600 text-[10px] font-black px-3 py-1.5 rounded-full shadow-2xl flex items-center gap-1.5 z-10 border border-blue-100">
          ...
          <div class="p-6 space-y-5">
             ...
             <div class="grid grid-cols-2 gap-y-3 gap-x-6 border-y border-slate-800/50 py-4">
                <div *ngIf="v.potencia" class="flex items-center gap-3 text-slate-400 text-xs font-bold uppercase tracking-widest">
                ...
                <div *ngIf="v.kilometraje !== undefined" class="flex items-center gap-3 text-slate-400 text-xs font-bold uppercase tracking-widest">
                   <div class="w-8 h-8 rounded-lg bg-blue-500/10 flex items-center justify-center text-blue-500">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                   </div>
                   {{ v.kilometraje }} Km
                </div>
                <div *ngIf="v.plazas" class="flex items-center gap-3 text-slate-400 text-xs font-bold uppercase tracking-widest">
                   <div class="w-8 h-8 rounded-lg bg-blue-500/10 flex items-center justify-center text-blue-500">
                ...
                <div *ngIf="v.fechaFabricacion" class="flex items-center gap-3 text-slate-400 text-xs font-bold uppercase tracking-widest">
                   <div class="w-8 h-8 rounded-lg bg-blue-500/10 flex items-center justify-center text-blue-500">
