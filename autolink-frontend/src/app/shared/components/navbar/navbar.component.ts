        ...
        <div class="flex justify-between h-16 items-center">
          ...
          <div class="hidden md:flex items-center gap-6">
            ...
            <ng-container *ngIf="authService.isAuthenticated()">
              <a *ngIf="isCliente()" routerLink="/cliente" routerLinkActive="text-blue-500" class="hover:text-blue-400 transition-colors font-medium">Mis Compras</a>
              <a *ngIf="isVendedor()" routerLink="/vendedor" routerLinkActive="text-blue-500" class="hover:text-blue-400 transition-colors font-medium">Mi Stock</a>
              <a *ngIf="isAdmin()" routerLink="/admin" routerLinkActive="text-blue-500" class="hover:text-blue-400 transition-colors font-medium">Panel Admin</a>
